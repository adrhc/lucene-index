...
import ro.go.adrhc.persistence.lucene.index.operations.restore.IndexShallowUpdateServiceParamsImpl;
import ro.go.adrhc.persistence.lucene.index.operations.retrieve.IndexRetrieveServiceParams;
import ro.go.adrhc.persistence.lucene.index.operations.retrieve.IndexRetrieveServiceParamsImpl;
import ro.go.adrhc.persistence.lucene.index.operations.search.IndexSearchServiceParams;
import ro.go.adrhc.persistence.lucene.index.operations.search.IndexSearchServiceParamsImpl;
